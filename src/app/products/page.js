                    ...
                    <div className="space-y-6">
                      ...
                      {list.map((product) => (
                        ...
                        <div
                          key={product.slug}
                          id={product.slug}
                          className="group bg-white rounded-[28px] border border-slate-200 shadow-lg p-7 hover:shadow-2xl hover:border-red-500/40 hover:-translate-y-1 hover:shadow-red-500/5 transition-all duration-300"
                        >
                          ...
                          <div className="grid lg:grid-cols-[250px_1fr_180px] gap-8 items-center">
                            ...
                            <div className="bg-slate-100 rounded-2xl h-[220px] flex items-center justify-center overflow-hidden">
                              ...
                              <Image
                                ...
                                width={220}
                                height={220}
                                className="object-contain max-h-[180px] group-hover:scale-105 transition-all duration-500"
                              />
